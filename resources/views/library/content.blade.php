                   ...
                   <div class="iq-card-header-toolbar d-flex align-items-center">
                      <div class="dropdown">
                         ...
                         <div class="dropdown-menu dropdown-menu-right shadow-none" aria-labelledby="dropdownMenuButton2">
                            ...
                            <a class="dropdown-item" href="index.html#"><i class="ri-delete-bin-6-fill mr-2"></i>Delete</a>
                            <a class="dropdown-item" href="index.html#"><i class="ri-pencil-fill mr-2"></i>Edit</a>
                            <a class="dropdown-item" href="index.html#"><i class="ri-printer-fill mr-2"></i>Print</a>
                            <a class="dropdown-item" href="index.html#"><i class="ri-file-download-fill mr-2"></i>Download</a>
                         </div>
                      </div>
                   </div>
                </div>
                      ...
                      <li class="col-md-4">
                         <div class="d-flex align-items-center">
                            ...
                            <div class="col-7">
                               ...
                               <a href="index.html#" class="text-dark">Read Now<i class="ri-arrow-right-s-line"></i></a>
                            </div>
                         </div>
                      </li>
                      <li class="col-md-4">
